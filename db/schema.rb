...
ActiveRecord::Schema.define(version: 20_220_208_095_835) do
  ...
  create_table 'order_items', force: :cascade do |t|
    ...
    t.index %w[product_type product_id], name: 'index_order_items_on_product'
  ...
  create_table 'user_events', force: :cascade do |t|
    ...
    t.index %w[subject_type subject_id], name: 'index_user_events_on_subject'
